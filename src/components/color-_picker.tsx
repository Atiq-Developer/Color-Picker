...
export default function ColorPicker() {
  ...
  return (
    <div className="bg-slate-200 flex flex-col items-center justify-center h-screen dark:bg-gray-900">
      {/* Center the color picker card within the screen */}
      <Card className="w-full max-w-md mx-auto p-8 grid gap-8 border-gray-600">
